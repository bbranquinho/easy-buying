...
public class Notification_Template extends BaseEntity<Long> {
    ...
    public Notification_Template(String message, Integer notification_type_id, Integer supplier_id) {
        super();
    ...
    public Notification_Template(String message) {
        this.message = message;
    }
