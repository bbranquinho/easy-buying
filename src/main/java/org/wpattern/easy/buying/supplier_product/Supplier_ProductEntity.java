...
public class Supplier_ProductEntity extends BaseEntity<Long> {
    ...
    public Supplier_ProductEntity() {
    }

    public Supplier_ProductEntity(Integer supplier_id, Integer product_id) {
        super();
        this.supplier_id = supplier_id;
        this.product_id = product_id;
    }

    public Supplier_ProductEntity(Integer supplier_id) {this.supplier_id = supplier_id; }
