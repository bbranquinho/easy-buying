...
public class Quotation extends BaseEntity<Long> {
    ...
    public Quotation(Integer product_request_id, Integer supplier_id, Float unitary_price, Float total_price, Integer quantity) {
        super();
    ...
    public Quotation(Integer product_request_id) {
        this.product_request_id = product_request_id;
    }
